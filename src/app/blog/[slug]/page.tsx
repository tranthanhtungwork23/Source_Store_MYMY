...
export default async function BlogDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fff8ef_0%,#fff4df_100%)] px-4 py-6 sm:px-6">
      <article className="mx-auto max-w-4xl rounded-[2rem] bg-white p-5 shadow-sm sm:p-8">
        ...
        <p className="mt-6 text-xs font-bold uppercase tracking-[0.2em] text-orange-700">
        ...
        <div className="mt-10 rounded-3xl bg-orange-50 p-5">
          ...
          <p className="mt-2 text-sm leading-6 text-stone-600">Xem menu đồ ăn vặt, chọn món và gửi đơn trực tiếp trên website.</p>
